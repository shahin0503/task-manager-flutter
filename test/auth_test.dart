...
import 'package:taskmanager/services/auth/auth_exceptions.dart';
import 'package:taskmanager/services/auth/auth_provider.dart';
import 'package:taskmanager/services/auth/auth_user.dart';
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<void> sendEmailVerification() async {
    if (!isInitialized) throw NotInitializedException();
    final user = _user;
    if (user == null) throw InvalidLoginCredentialsAuthException();
